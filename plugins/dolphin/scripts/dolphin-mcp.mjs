...
import { createDolphinController } from "./dolphin-lib.mjs";
  ...
  switch (message.method) {
    case "initialize":
      sendResult(message.id, {
        ...
        serverInfo,
        instructions:
          "Use Dolphin tools for Linux-native file-manager work. Prefer filesystem tools for background work; UI tools only open Dolphin, dialogs, clipboard providers, or terminals when explicitly needed.",
      });
      return;
    case "ping":
      sendResult(message.id, {});
